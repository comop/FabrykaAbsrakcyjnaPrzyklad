...
public class GrafNieskierowanyLista implements GrafNieskierowany {
    ...
    protected GrafNieskierowanyLista(ArrayList<ArrayList<Integer>> listySasiedztwa) {
